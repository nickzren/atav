...
atav.sh --coverage-summary --sample $ATAV_TEST_PATH/ped --covered-region $ATAV_TEST_PATH/coverage_region --out $ATAV_OUTPUT_PATH/old/coverage_summary --min-coverage 10

...
public class KnownVarManager {
    ...
    private static final Multimap<String, DBDSM_test> dbDSMMultiMap = ArrayListMultimap.create();
    ...
    private static void initDBDSMMap() {
        try {
            ...
            while (rs.next()) {
                ...
                DBDSM_test dbDSM = new DBDSM_test(chr, pos, ref, alt,
    ...
    public static Multimap<String, DBDSM_test> getDBDSMMultiMap() {
        return dbDSMMultiMap;
    }

    public static DBDSMOutput getDBDSMOutput(Variant var) {
        Collection<DBDSM_test> collection = dbDSMMultiMap.get(var.getSiteId());

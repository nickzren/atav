...
public class SubRvisManager {
    ...
    private static final String SUBRVIS_DOMAIN_PATH = "data/subrvis/domain_score_052816.txt.gz";
    private static final String SUBRVIS_EXON_PATH = "data/subrvis/exon_score_052816.txt.gz";

package atav.analysis.coverage;

import atav.analysis.coverage.base.SampleStatistics;
import atav.analysis.coverage.base.CoveredRegion;
import atav.analysis.coverage.base.Exon;
import atav.analysis.coverage.base.Gene;
import atav.analysis.coverage.base.InputList;
import atav.analysis.coverage.base.Transcript;
...
public class CoverageSummary extends InputList {
    ...
    BufferedWriter bwSampleMatrixSummary = null;
    BufferedWriter bwSampleExonMatrixSummary = null;
    BufferedWriter bwCoverageDetailsByExon = null;
    BufferedWriter bwCoverageSummaryByExon = null;
    BufferedWriter bwCoverageSummaryByGene = null;

    final String sampleSummaryFilePath = CommandValue.outputPath + "sample.summary.csv";
    final String coverageDetailsFilePath = CommandValue.outputPath + "coverage.details.csv";
    final String coverageDetailsByExonFilePath = CommandValue.outputPath + "coverage.details.by.exon.csv";
    final String coverageMatrixFilePath = CommandValue.outputPath + "coverage.details.matrix.csv";
    final String coverageExonMatrixFilePath = CommandValue.outputPath + "coverage.details.matrix.by.exon.csv";

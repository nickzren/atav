...
atav_latest.sh --disable-timestamp-from-out-path --coverage-comparison --sample $ATAV_TEST_PATH/trio_sample.txt --gene-boundary $ATAV_TEST_PATH/gene_boundaries --min-coverage 10 --out $ATAV_OUTPUT_PATH/old/coverage_comparison
